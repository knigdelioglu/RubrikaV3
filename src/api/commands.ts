...
export const commands = {
  ...
  createPerformanceTask: async (input: {
    projectId: string;
    academicYearId: string;
    courseId: string;
    courseName: string;
    ...
    initialRubric?: PerformanceRubric;
  }): Promise<AssessmentActivity> => {
    try {
      return await invoke<AssessmentActivity>('create_performance_task', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  updatePerformanceTask: async (input: {
    projectId: string;
    activityId: string;
    title?: string;
    performanceDetails?: PerformanceDetails;
    ...
    try {
      return await invoke<AssessmentActivity>('update_performance_task', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  listPerformanceTasks: async (input: {
    projectId: string;
    courseId?: string;
    term?: number;
    schoolClassId?: string;
    ...
    try {
      return await invoke<AssessmentActivity[]>('list_performance_tasks', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  getPerformanceTask: async (input: { projectId: string; activityId: string }): Promise<AssessmentActivity> => {
    try {
      return await invoke<AssessmentActivity>('get_performance_task', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  publishPerformanceRubric: async (input: {
    projectId: string;
    activityId: string;
    rubric: PerformanceRubric;
  }): Promise<PerformanceRubric> => {
    try {
      return await invoke<PerformanceRubric>('publish_performance_rubric', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  getPerformanceRubricHistory: async (input: { projectId: string; activityId: string }): Promise<PerformanceRubric[]> => {
    try {
      return await invoke<PerformanceRubric[]>('get_performance_rubric_history', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  savePerformanceAssessment: async (input: {
    projectId: string;
    activityId: string;
    applicationId: string;
    studentId: string;
    ...
    try {
      return await invoke<PerformanceAssessment>('save_performance_assessment', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  approvePerformanceAssessment: async (input: {
    projectId: string;
    activityId: string;
    applicationId: string;
    assessmentId: string;
    ...
    try {
      return await invoke<PerformanceAssessment>('approve_performance_assessment', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  setPerformanceAssessmentStatus: async (input: {
    projectId: string;
    activityId: string;
    applicationId: string;
    studentId: string;
    ...
    try {
      return await invoke<PerformanceAssessment>('set_performance_assessment_status', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  listPerformanceAssessments: async (input: {
    projectId: string;
    activityId: string;
    applicationId?: string;
  }): Promise<PerformanceAssessment[]> => {
    try {
      return await invoke<PerformanceAssessment[]>('list_performance_assessments', { input });
    } catch (e) {
      handleInvokeError(e);
    }
  },
  getPerformanceReport: async (input: {
    projectId: string;
    activityId: string;
    applicationId: string;
